...
class KisiselGelisimChallenge extends StatefulWidget {
  const KisiselGelisimChallenge({super.key});

  @override
  State<KisiselGelisimChallenge> createState() => _KisiselGelisimChallengeState();
}

class _KisiselGelisimChallengeState extends State<KisiselGelisimChallenge> {
  ...
  void initState() {
    super.initState();
    _loadPassedDays();
    context.read<PariltiliDegisimCubit>().getKisiselGelisimChallenges();
  }
              ...
              child: Row(
                children: [
                  ...
                  Padding(
                    ...
                    child: Column(
                      children: [
                        Text("Kişisel Gelişim",style: TextStyle(fontSize: 19,fontFamily: 'font4',fontWeight: FontWeight.bold,color: Colors.black54),),
                  ...
                  Padding(
                    ...
                    child: SizedBox(width:80, child: Image.asset("images/challenge_kisiselgelisim.png")),
                  ),
                ],
              ),
            ),
