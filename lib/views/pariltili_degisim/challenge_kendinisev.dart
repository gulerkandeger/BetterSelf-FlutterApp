...
class KendiniSevChallenge extends StatefulWidget {
  const KendiniSevChallenge({super.key});

  @override
  State<KendiniSevChallenge> createState() => _KendiniSevChallengeState();
}

class _KendiniSevChallengeState extends State<KendiniSevChallenge> {
  ...
  void initState() {
    super.initState();
    _loadPassedDays();
    context.read<PariltiliDegisimCubit>().getKendiniSevChallenges();
  }
              ...
              child: Row(
                children: [
                  ...
                  Padding(
                    ...
                    child: Column(
                      children: [
                        Text("Kendini Sev",style: TextStyle(fontSize: 19,fontFamily: 'font4',fontWeight: FontWeight.bold,color: Colors.black54),),
                        Text("Challenge",style: TextStyle(fontSize: 23,fontFamily: 'font4',fontWeight: FontWeight.bold,color: Colors.black54),),
                      ],
                    ),
                  ),
                  Spacer(),
                  Padding(
                    ...
                    child: SizedBox(width:60, child: Image.asset("images/challenge_kendinisev.png")),
                  ),
                ],
              ),
            ),
