...
class UretkenlikChallenge extends StatefulWidget {
  const UretkenlikChallenge({super.key});

  @override
  State<UretkenlikChallenge> createState() => _UretkenlikChallengeState();
}

class _UretkenlikChallengeState extends State<UretkenlikChallenge> {
  ...
  _loadPassedDays() async {
    ...
    if (firstEntryDate != null) {
      ...
      int difference = now.difference(entryDate).inHours;
  ...
  void initState() {
    super.initState();
    _loadPassedDays();
    context.read<PariltiliDegisimCubit>().getUretkenlikChallenges();
  }
              ...
              child: Row(
                children: [
                  ...
                  Padding(
                    ...
                    child: Column(
                      children: [
                        Text("Üretkenlik",style: TextStyle(fontSize: 21,fontFamily: 'font4',fontWeight: FontWeight.bold,color: Colors.black54),),
                        Text("Challenge",style: TextStyle(fontSize: 21,fontFamily: 'font4',fontWeight: FontWeight.bold,color: Colors.black54),),
                      ],
                    ),
                  ),
                  Spacer(),
                  Padding(
                    ...
                    child: SizedBox(width:80, child: Image.asset("images/challenge_uretkenlik.png")),
                  ),
                ],
              ),
            ),
