...
class OzguvenChallenge extends StatefulWidget {
  const OzguvenChallenge({super.key});

  @override
  State<OzguvenChallenge> createState() => _OzguvenChallengeState();
}

class _OzguvenChallengeState extends State<OzguvenChallenge> {
  ...
  void initState() {
    super.initState();
    _loadPassedDays();
    context.read<PariltiliDegisimCubit>().getOzguvenChallenges();
  }
              ...
              child: Row(
                children: [
                  ...
                  Padding(
                    ...
                    child: Column(
                      children: [
                        Text("Özgüven",style: TextStyle(fontSize: 23,fontFamily: 'font4',fontWeight: FontWeight.bold,color: Colors.black54),),
                  ...
                  Padding(
                    ...
                    child: SizedBox(width:80, child: Image.asset("images/challenge_ozguven.png")),
                  ),
                ],
              ),
            ),
