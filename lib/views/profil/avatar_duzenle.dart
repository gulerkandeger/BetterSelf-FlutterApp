...
class AvatarDuzenle extends StatefulWidget {
  const AvatarDuzenle({super.key});

  @override
  State<AvatarDuzenle> createState() => _AvatarDuzenleState();
}

class _AvatarDuzenleState extends State<AvatarDuzenle> {
                ...
                itemBuilder: (context, index) {
                  return GestureDetector(
                    ...
                    onTap: (){
                      ...
                      Navigator.pushReplacement(context, MaterialPageRoute(builder: (context)=>ProfiliDuzenle()));
                    },
                  );
                },
              ),
