...
class ZincirKayit extends StatefulWidget {
  const ZincirKayit({super.key});

  @override
  State<ZincirKayit> createState() => _ZincirKayitState();
}

class _ZincirKayitState extends State<ZincirKayit> {
            ...
            children: [
              ...
              SizedBox(
                ...
                child: TextField(
                  ...
                  decoration: InputDecoration(
                    ...
                    hintText: "Alışkanlık Adı Giriniz",
              ...
              SizedBox(
                ...
                child: TextFormField(
                  ...
                  decoration: InputDecoration(
                    filled: true,
                    fillColor: MyColors.mc_ametistLight,
                    hintText: "Alışkanlık Açıklaması Giriniz",
                    hintStyle: TextStyle(color: Colors.grey,fontSize: 15),
                    border: OutlineInputBorder(
                        borderRadius: BorderRadius.circular(15),
                        borderSide: BorderSide.none
              ...
              Padding(
                ...
                child: ElevatedButton(
                  ...
                  onPressed: (){
                    if(tf_zincirName.text.isNotEmpty){
                      if(tf_zincirDesc.text.isNotEmpty){
                        zincirKaydet();
                      ...
                      ScaffoldMessenger.of(context).showSnackBar(
                        SnackBar(content: Text("Alışkanlık Adı ve Alışkanlık Açıklaması girin !"),),
                      );
                    }
                  },
                ),
